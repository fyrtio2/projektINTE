...
public class EquipmentTest {
    ...
    public void isWearableByTest() {
        ...
        Equipment ring = new Equipment("Ring", 100, 2, 10,10); // Creates equipment with level 2 requirement
    ...
    public void damageEquipmentTest() {
        Equipment helmet = new Equipment("Helmet", 100,  10, 10,10); // Helmet created with 10 durability
    ...
    public void testIfEquipmentBroken() {
        Equipment armor = new Equipment("Armor", 100, 10, 10,10); // Armor created with 10 durability
    ...
    public void isEnchantedTest() throws Exception {
        Equipment axe = new Equipment("Axe", 100, 10, 10,10);
        axe.enchantItem();
